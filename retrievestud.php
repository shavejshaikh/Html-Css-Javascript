	...
	if($count == 1)
	 {
         ...
         echo "<script language='javascript' type='text/javascript'>alert('User Name Or Password Invalid!');
      ...
      {
          echo "<script type='text/javascript'>alert('You Are A Valid User!');window.location.href='Submission.html';</script>";
      }
